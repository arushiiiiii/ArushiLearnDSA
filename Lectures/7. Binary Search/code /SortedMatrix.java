// This is a strictly sorted 2D array.
...
// Search in the row provided between the columns provided.
    ...
    static int[] search(int[][] matrix, int target) {
        ...
        // search in 3rd half
        if (target < matrix[rEnd][cMid] && target >= matrix[rEnd][0]) {
...
// The time complexity will be log(n) + log(m). n-> binary search in col; m-> binary search in rows.
